...
//To more easily refer to the object and contain the value of the object in context
...
//Apply uses arrays to pass in parameters, call just does it the normal way. ex fireweapon.call(player, 10, 5); fireweapon.apply(player, [])

  // 4) What does .bind do?

//sets the "this" value on methods
...
setTimeout(getMyUsername.user, 5000);
